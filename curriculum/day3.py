day3 = {
    ...
    "guided_practice": "Students work in groups to match science tools to measurement tasks, such as measuring mass, volume, temperature, length, force, and observations.",
