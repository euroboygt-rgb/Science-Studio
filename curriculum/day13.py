day13 = {
    ...
    "title": "Soluble and Insoluble Materials",
    "teks": ["5.6A"],

    "bell_ringer": "A student stirs salt into a cup of water. After a few minutes, the salt can no longer be seen. What physical property is being observed?",
    ...
    "lab_notebook_table": {
        "columns": [
            "Material",
            "Prediction: Soluble or Insoluble?",
    ...
    "staar_practice": [
        {
            "question": "A student stirs sugar into water. After stirring, the sugar can no longer be seen. What property is being tested?",
            "choices": [
                "Magnetism",
                "Solubility",
                "Conductivity",
        ...
        {
            "question": "A student mixes sand with water. The sand settles at the bottom of the cup. Which conclusion is best supported by this observation?",
            "choices": [
        ...
        {
            "question": "Which material would most likely dissolve in water?",
            "choices": [
                "Salt",
                "Gravel",
                "Paper clip",
        ...
        {
            "question": "A student wants to test whether a white powder is soluble in water. Which procedure is best?",
            "choices": [
                "Place the powder near a magnet",
                "Place the powder in water, stir, and observe whether it dissolves",
                "Measure the temperature of the powder",
                "Place the powder on a balance"
            ],
            "answer": "Place the powder in water, stir, and observe whether it dissolves"
        },
        {
            "question": "Which observation is evidence that a material is insoluble in water?",
            "choices": [
                "The material disappears after stirring",
                "The material forms a layer on top or settles at the bottom",
                "The water becomes colder",
                "The material becomes magnetic"
            ],
            "answer": "The material forms a layer on top or settles at the bottom"
        }
    ],

    "exit_ticket": "Choose one material from today's lab. Was it soluble or insoluble in water? Use evidence from your observation to explain your answer.",
    ...
    "vocabulary": [
        ...
        {
            "term": "soluble",
            "picture": "Picture of sugar dissolving in water",
        ...
        {
            "term": "insoluble",
            "picture": "Picture of sand at the bottom of a cup of water",
            "definition": "Not able to dissolve in a liquid.",
        ...
        {
            "term": "dissolve",
            "picture": "Picture of salt disappearing into water",
        ...
        },
        {
            ...
            "example": "The sand stayed at the bottom, so the evidence shows it is insoluble.",
            ...
            "staar_connection": "On STAAR, students must use evidence from observations, pictures, tables, and investigations."
        }
    ],
