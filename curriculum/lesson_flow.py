...
def get_mcgraw_connection(day):
    day = int(day)

    if day <= 2:
        title = "McGraw Hill Science Skills Connection"
        focus = "Science safety, science tools, observations, data, and investigation routines"
    elif day <= 16:
        title = "McGraw Hill Unit Connection: Physical Properties of Matter"
        focus = "Matter, mass, volume, physical state, magnetism, relative density, solubility, and conductivity"
    elif day <= 26:
        title = "McGraw Hill Unit Connection: Mixtures and Solutions"
        focus = "Mixtures, solutions, separating mixtures, dissolving, particles too small to see, and conservation of matter"
    elif day <= 36:
        title = "McGraw Hill Unit Connection: Force and Motion"
        focus = "Pushes, pulls, balanced and unbalanced forces, motion, mechanical energy, variables, and data"
    elif day <= 43:
        title = "McGraw Hill Unit Connection: Energy Transformations"
        focus = "Chemical, mechanical, electrical, light, thermal, and sound energy; energy flow through systems"
    else:
        title = "McGraw Hill Review Connection"
        focus = "Use the connected McGraw Hill unit pages to review vocabulary, diagrams, investigations, and reading passages"

    return {
        "title": title,
        "focus": focus,
        "teacher_use": "Use the district-approved McGraw Hill lesson as the reading, diagram, image, or vocabulary support for today’s concept. Do not copy protected pages into the public website.",
        "student_use": "Students should use the McGraw Hill connection to review vocabulary, diagrams, and examples that match today’s learning target.",
        "look_for": "Look for students connecting the textbook example back to today’s investigation, STAAR practice, exit ticket, and CER response."
    }
...
def get_lesson_flow(day, title=""):
    ...
    return {
        ...
        "mcgraw_connection": get_mcgraw_connection(day),
    }
